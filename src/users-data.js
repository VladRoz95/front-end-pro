...
for (let user of data.users) {
  ...
  editBtn.addEventListener('click', () => {
    console.log('clicked')
    document.getElementById('iName').value=user.firstName
    document.getElementById('Isur').value=user.lastName
    ...
    document.getElementById('hair-color').value = user.hair.color
  });
...
inputSurname.id = 'Isur';
inputSurname.required = true;
inputSurname.name='Surname'


let labelSur = document.createElement('label')
labelSur.innerHTML = 'Surname'
labelSur.appendChild(inputSurname)
...
labelGender1.innerHTML = 'Male';
labelGender1.appendChild(inputGender1);
para.appendChild(labelGender1)

inputGender1.type = 'radio';
inputGender1.name = 'gender';
inputGender1.value = 'Male';
inputGender1.required = true;

let inputGender2 = document.createElement('input');
let labelGender2 = document.createElement('label');
labelGender2.innerHTML = 'Female';
labelGender2.appendChild(inputGender2);
para.appendChild(labelGender2)


inputGender2.type = 'radio';
inputGender2.name = 'gender';
inputGender2.value = 'Female';
inputGender2.required = true;
...
let selectBlood = document.createElement('select');
selectBlood.id='blood'
selectBlood.required = true;
selectBlood.name = 'Blood-Group';
para2.appendChild(selectBlood)

let op1 = document.createElement('option');
op1.value = 'A+';
op1.innerHTML = 'A+';
selectBlood.appendChild(op1)

let op2 = document.createElement('option');
op2.value = 'A-';
op2.innerHTML = 'A-';
selectBlood.appendChild(op2)

let op3 = document.createElement('option');
op3.value = 'B+';
op3.innerHTML = 'B+';
selectBlood.appendChild(op3)

let op4 = document.createElement('option');
op4.value = 'B-';
op4.innerHTML = 'B-';
selectBlood.appendChild(op4)

let op5 = document.createElement('option');
op5.value = 'O+';
op5.innerHTML = 'O+';
selectBlood.appendChild(op5)

let op6 = document.createElement('option');
op6.value = 'O-';
op6.innerHTML = 'O-';
selectBlood.appendChild(op6)

let op7 = document.createElement('option');
op7.value = 'AB+';
op7.innerHTML = 'AB+';
selectBlood.appendChild(op7)

let op8 = document.createElement('option');
op8.value = 'AB-';
op8.innerHTML = 'AB-';
selectBlood.appendChild(op8)
...
let labelMmail = document.createElement('label')
labelMmail.innerHTML = 'Mail'
labelMmail.appendChild(inputMail)

////////

let inputPas = document.createElement('input');
inputPas.type='password'
inputPas.id='password'
inputPas.required = true;
inputPas.name = 'Password';

let labelPas = document.createElement('label');
labelPas.innerHTML = 'Password';
labelPas.appendChild(inputPas);
...
labelDate.innerHTML = 'Birth Date'
...
////////
let hairData = document.createElement('datalist');
hairData.id = 'hair-color';
hairData.name = 'Hair-color';

let list = document.getElementById('hair-color')
...
for (let i = 0; i < data.users.length; i++) {
  ...
  if (!hairColors.includes(hairColor)) {
...
for (let i = 0; i < hairColors.length; i++) {
  ...
  hairData.appendChild(option); 
}

let inputHair = document.createElement('input');
inputHair.list = 'hair-color';
inputHair.id = 'hair-color';
inputHair.required = true;
inputHair.appendChild(hairData)

let labelHair = document.createElement('label');
labelHair.innerHTML = 'Hair Color'
labelHair.appendChild(inputHair);
...
document.querySelector(".fName").textContent = document.getElementById("iName").value;
document.querySelector(".lName").textContent = document.getElementById("Isur").value;
  document.querySelector(".uMail").textContent = document.getElementById("iMail").value;
